        ...
        <div className="row">
          <div className="col__3">
            <div className="service__box pointer">
              <div className="icon">
                ...
                >
                  <path
                    d="M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2
                  v12a2 2 0 0 1-2 2h-6"
                  ></path>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">React Router Dom vs6</h1>
                <p className="p service__text p__color">
                  I throw myself down among the
                </p>
                <p className="p service__text p__color">
